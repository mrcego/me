<template>
  ...
  >
    ...
    <div class="container mx-auto space-y-24">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
        <Motion
        ...
        >
          ...
          >
            ...
            <div class="space-y-3 sm:space-y-4 max-w-xs mx-auto">
              ...
              <p class="text-muted text-sm sm:text-base md:text-base leading-relaxed font-medium">
