      ...
      <div class="grid xl:grid-cols-2 gap-10 lg:gap-12 xl:gap-16 items-center">
        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-3.5 md:gap-4">
            <AppSurface
              ...
              variant="glass-lite"
              rounded="2xl"
              class="contact-method flex items-center gap-3.5 sm:gap-4 md:gap-5 group touch-manipulation border border-foreground/10 px-3 py-3.5 md:px-4 md:py-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 min-w-0"
        ...
        >
          <AppSurface
            variant="glass"
            rounded="3xl"
            class="surface-card group p-6 sm:p-8 md:p-10 lg:p-12 border-foreground/5 relative overflow-hidden shadow-4xl mt-12 xl:mt-0"
          >
