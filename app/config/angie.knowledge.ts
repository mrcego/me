...
export const ANGIE_KNOWLEDGE_BASE: AngieKnowledgeEntry[] = [
  ...
  },
  {
    ...
    title: {
      en: 'Other Frameworks & Architecture Versatility',
      es: 'Otros Frameworks y Versatilidad Arquitectónica',
    },
    content: {
      en: 'While César specializes deeply in the Vue 3 / Nuxt 4 enterprise ecosystem (Composition API, Pinia, Nitro), he has strong hands-on experience with React, Next.js, Node.js microservices, and framework-agnostic Web Components for microfrontend federation.',
      es: 'Aunque la principal especialización de César es el ecosistema empresarial Vue 3 / Nuxt 4 (Composition API, Pinia, Nitro), cuenta con sólida experiencia práctica en React, Next.js, microservicios Node.js y Web Components estándar para arquitecturas de microfrontends.',
    },
    actions: [
      {
        id: 'act_stack',
